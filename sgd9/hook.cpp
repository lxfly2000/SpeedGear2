...
HRESULT __stdcall HookedIDirect3DDevice9_Present(LPDIRECT3DDEVICE9 pDevice, LPCRECT pSrc, LPCRECT pDest, HWND hwnd, const RGNDATA* pRgn)
{
	...
	{
		bUpdateList = false;
		SGSendMessageUpdateList(SG_UPDATE_LIST_ADD, SG_UPDATE_LIST_API_D3D9, GetCurrentProcessId());
	}
...
{
	SGSendMessageUpdateList(SG_UPDATE_LIST_REMOVE,SG_UPDATE_LIST_API_D3D9, GetCurrentProcessId());
